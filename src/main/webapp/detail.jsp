...
function showData(data){
	  ...
	  //document.querySelector("#testimg").innerHTML = data[0].bookImageURL ; 
	  //$("#testimg").html( data.bookImageURL);
	  console.log(data[0].bookImageURL);
	  document.querySelector("#testimg").src=data[0].bookImageURL; //"../images/dd.jpg";
	  //document.query
	  //$("#testimg").src(data[0].bookImageURL);
