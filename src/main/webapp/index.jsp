...
<div id ="section_wrap" class ="section02" >
	<div id ="book_text"  >
		...
		<input type="button" value = "가까운 오프라인매장 찾기" style="background-color: #a5df61; display: none;">
	</div>
...
<div id ="section_wrap" class ="section04">
	...
	<div id ="book_text">
		...
		<input type="button" value = "1개월 무료체험하기" style="background-color: #434242; color: white; display: none;">
	</div>
